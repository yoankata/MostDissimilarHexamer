using static MostDissimilarOligomer.Library.Data.RandomNucleotideOligomerGenerator;
using System;
using System.Threading.Tasks;
using MostDissimilarOligomer.Library.Extensions;

namespace MostDissimilarOligomer.App
{
    class Program
    {
